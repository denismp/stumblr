...
public class NewTextPostControllerTest {
	...
	NewTextPostController controller;
	...
	public void setUp() {
		...
		controller = new NewTextPostController();
	...
	public void testHandleRequestInternalHttpServletRequestHttpServletResponse() throws Exception {
		...
		request.setRequestURI("/new/text.blr");
		request.addParameter("postText", "my post text");
		request.addParameter("title", "my title");
